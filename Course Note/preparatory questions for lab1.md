...
* We need satisfied WCET values for each tasks, then we can get a valid minor preiod and major preiod. So that our scheduling will be valid.
...
* Each tasks will never miss their deadline because of unsuitable minor cycling or underestimated WCET values.